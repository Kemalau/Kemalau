...
- [`Codeshift`](https://github.com/Kemalau/Codeshift) — Lightweight coding agent with repo maps and dependency-aware Python type-hint migration.
- [`LatentCompress-A-protocol-for-high-compressed-agent-communication`](https://github.com/Kemalau/LatentCompress-A-protocol-for-high-compressed-agent-communication) — Exploring high-compression protocols for agent communication.
- [`xiaozhi-client`](https://github.com/Kemalau/xiaozhi-client) — AI client focused on MCP integration.
- [`TransReID`](https://github.com/Kemalau/TransReID) — Research-oriented repository for representation and identification tasks.
